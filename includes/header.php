    <header class="l-header js-header">
        <h1 class="l-header-logo u-logo-hover">
            <a href="<?php echo esc_url(home_url('/')); ?>">
                <img width="251" height="46" src="<?php echo get_template_directory_uri(); ?>/img/logo.png" alt="建築サービス <?php bloginfo("name"); ?>"
                    decoding="async">
            </a>
        </h1>
                ...
                <ul class="l-header-menu-list">
                    ...
                    <li class="l-header-menu-item">
                        <a href="<?php echo esc_url(home_url('/contact/')); ?>"
                            class="l-header-menu-link l-header-menu-link--contact">
